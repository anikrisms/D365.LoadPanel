...
export class field implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement)
	{
		...
		let f= "Field=" +(context.parameters.sampleProperty?.attributes?.DisplayName || context.parameters.sampleProperty?.attributes?.LogicalName ||"Test");
		p.innerHTML = "TestApp- <br\>" +
		 f+ "<br\>" +
		"value=" +(context.parameters.sampleProperty?.raw || "value");
